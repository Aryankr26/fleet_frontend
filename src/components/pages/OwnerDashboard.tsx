...
import mapImage from '../../assets/494a3e5749234580c611bc616000d2fd7d637deb.png';
//import mapImage from '../../assets/494a3e5749234580c611bc616000d2fd7d637deb.png';
...
export function OwnerDashboard({ onNavigate, selectedVehicleId }: { onNavigate?: (page: string, vehicleId?: string) => void; selectedVehicleId?: string }) {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-auto">
      {/* Map Background - Constrained to left side on desktop, full width on mobile */}
      <div 
        className="absolute inset-y-0 left-0 lg:right-[340px] right-0 overflow-hidden cursor-grab active:cursor-grabbing"
      >
        <img 
          src={mapImage}
          alt="Fleet Map"
        ...
        <div className="absolute top-4 md:top-6 left-1/2 transform -translate-x-1/2 z-20 w-[95%] md:w-auto overflow-x-auto">
          <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-2xl p-2 md:p-3">
            <div className="flex items-center gap-1 md:gap-2 min-w-max md:min-w-0">
              ...
              >
                <div className="flex flex-col items-center">
                  <span className="text-lg md:text-xl">{vehicleCounts.all}</span>
                  <span className="text-[10px] md:text-xs whitespace-nowrap">All</span>
                </div>
              </button>
              ...
              >
                <div className="flex flex-col items-center">
                  <span className="text-lg md:text-xl">{vehicleCounts.moving}</span>
                  <span className="text-[10px] md:text-xs whitespace-nowrap">Moving</span>
                </div>
              </button>
              ...
              >
                <div className="flex flex-col items-center">
                  <span className="text-lg md:text-xl">{vehicleCounts.idling}</span>
                  <span className="text-[10px] md:text-xs whitespace-nowrap">Idle</span>
                </div>
              </button>
              ...
              >
                <div className="flex flex-col items-center">
                  <span className="text-lg md:text-xl">{vehicleCounts.stopped}</span>
                  <span className="text-[10px] md:text-xs whitespace-nowrap">Stopped</span>
                </div>
              </button>
              ...
              >
                <div className="flex flex-col items-center">
                  <span className="text-lg md:text-xl">{vehicleCounts.offline}</span>
                  <span className="text-[10px] md:text-xs whitespace-nowrap">Offline</span>
                </div>
              </button>
              ...
              >
                <div className="flex flex-col items-center">
                  <span className="text-lg md:text-xl">{vehicleCounts.geofence}</span>
                  <span className="text-[10px] md:text-xs whitespace-nowrap">Geofence</span>
                </div>
              </button>
              ...
              >
                <div className="flex flex-col items-center">
                  <span className="text-lg md:text-xl">{vehicleCounts.unsubscribed}</span>
                  <span className="text-[10px] md:text-xs whitespace-nowrap">Unsubscribed</span>
                </div>
              </button>
            </div>
          </div>
        ...
        {/* Zoom Controls */}
        <div className="absolute bottom-4 md:bottom-8 right-4 md:right-8 lg:right-[360px] flex flex-col gap-2 z-20">
          <button
            onClick={handleZoomIn}
            className="w-10 h-10 md:w-12 md:h-12 bg-white hover:bg-slate-50 rounded-lg shadow-lg flex items-center justify-center transition-all hover:scale-105 active:scale-95"
            title="Zoom In"
          >
      ...
      <AnimatePresence>
        {selectedVehicle && (
            <motion.div
              className="absolute bottom-8 left-1/2 z-30 transform -translate-x-1/2 w-full px-4 sm:px-6"
          ...
          >
              <div
              className="bg-white rounded-[16px] border border-[#E1E6EF] w-full max-w-3xl mx-auto"
              style={{
      ...
      <AnimatePresence>
        {detailVehicle && (
          ...
          >
            <motion.div
              className="bg-white rounded-[20px] border border-[#E1E6EF] mx-4 w-full max-w-3xl"
              style={{
