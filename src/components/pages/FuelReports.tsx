    ...
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
        <Card className="border-slate-200">
          <CardContent className="p-4 md:p-6">
            <div className="flex items-center gap-2 mb-2">
              <Droplet className="h-4 w-4 md:h-5 md:w-5 text-cyan-500" />
              <p className="text-xs md:text-sm text-slate-600">Total Fuel Refilled</p>
            </div>
        ...
        <Card className="border-slate-200">
          <CardContent className="p-4 md:p-6">
            <div className="flex items-center gap-2 mb-2">
              <Navigation className="h-4 w-4 md:h-5 md:w-5 text-blue-500" />
              <p className="text-xs md:text-sm text-slate-600">Total Distance</p>
            </div>
        ...
        <Card className="border-slate-200">
          <CardContent className="p-4 md:p-6">
            <div className="flex items-center gap-2 mb-2">
              <Gauge className="h-4 w-4 md:h-5 md:w-5 text-green-500" />
              <p className="text-xs md:text-sm text-slate-600">Overall Avg Efficiency</p>
            </div>
        ...
        <Card className="border-slate-200">
          <CardContent className="p-4 md:p-6">
            <div className="flex items-center gap-2 mb-2">
              <CalendarIcon className="h-4 w-4 md:h-5 md:w-5 text-purple-500" />
              <p className="text-xs md:text-sm text-slate-600">Total Cost</p>
            </div>
      ...
      <Card className="border-slate-200">
        ...
        <CardContent>
          {/* Date Filter Buttons */}
          <div className="mb-4 md:mb-6 flex flex-col sm:flex-row sm:items-center gap-2 md:gap-3 p-3 md:p-4 bg-slate-50 rounded-lg border border-slate-200">
            <div className="flex items-center gap-2">
              <CalendarIcon className="h-4 w-4 text-slate-600" />
              <span className="text-xs md:text-sm text-slate-600">Filter by Date:</span>
            </div>
          ...
          <div className="mb-4 p-3 md:p-4 bg-slate-50 rounded-lg border border-slate-200 flex items-center justify-between">
          ...
          {filteredData.length === 0 && (
            <div className="text-center py-8 md:py-12">
              <p className="text-sm md:text-base text-slate-500">No refill records found matching your criteria</p>
            </div>
          )}
        </CardContent>
      </Card>
      ...
      <Card className="border-slate-200 bg-blue-50">
        <CardContent className="p-4 md:p-6">
          <h4 className="text-xs md:text-sm text-blue-900 mb-2 md:mb-3 flex items-center gap-2">
